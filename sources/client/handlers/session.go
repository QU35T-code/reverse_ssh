...
import (
	...
	"github.com/QU35T-code/reverse_ssh/pkg/storage"
	"github.com/QU35T-code/reverse_ssh/sources"
	"github.com/QU35T-code/reverse_ssh/sources/client/handlers/subsystems"
...
func Session(user *sources.User, newChannel ssh.NewChannel, log logger.Logger) {
	...
	for req := range requests {
		...
		case "shell":
			...
			var shellPath sources.ShellStruct
		...
		case "pty-req":
			...
			pty, err := sources.ParsePtyReq(req.Payload)
			if err != nil {
