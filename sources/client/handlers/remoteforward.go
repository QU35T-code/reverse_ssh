...
var currentRemoteForwards = map[sources.RemoteForwardRequest]net.Listener{}

func StopRemoteForward(rf sources.RemoteForwardRequest) error {
...
func StartRemoteForward(user *sources.User, r *ssh.Request, sshConn ssh.Conn) {
...
func handleData(rf sources.RemoteForwardRequest, proxyCon net.Conn, sshConn ssh.Conn) error {
	...
	drtMsg := sources.ChannelOpenDirectMsg{
		Raddr: rf.BindAddr,
		Rport: rf.BindPort,
