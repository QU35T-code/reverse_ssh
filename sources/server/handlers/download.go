...
func Download(dataDir string) func(user *sources.User, newChannel ssh.NewChannel, log logger.Logger) {
	return func(user *sources.User, newChannel ssh.NewChannel, log logger.Logger) {
